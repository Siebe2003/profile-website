...
function Footer() {
  return (
    <footer className="w-full py-14 bg-background">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          <Image height={100} width={300} src="/images/powered-by-bgg.png" alt="Powered by BoardGameGeek"  className="w-full px-[30%]"/>
