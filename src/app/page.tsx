  ...
  return (
    <main className="flex flex-col items-center lg:flex-row-reverse lg:px-20 lg:gap-20 2xl:gap-30 2xl:px-30 3xl:gap-50">
      ...
      <div className="text-foreground flex flex-col gap-10 items-center p-8 md:p-20 md:pt-10 lg:p-0 lg:items-start lg:flex-5 2xl:gap-16">
        ...
        <p className="text-center md:text-start 3xl:text-lg">Hello and welcome to my personal website. 
          My name is Siebe Verhaegen and I&#39;m a software developer from the city Ranst. 
          I have recently graduated from the school Thomas More situated in Lier, following a course in Programming. 
